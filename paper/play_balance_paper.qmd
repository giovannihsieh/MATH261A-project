---
title: "Analyzing the Relationship Between Offensive Play Balance and Score Differential in the NFL(1999-2022)"
subtitle: "An Analysis Using Simple Linear Regression"
...
date: today
date-format: long
abstract: "This study examines the relationship between offensive play balance and team score differential in the NFL using data from 1999-2022. Offensive play balance was defined as the ratio of run plays to pass plays, and a simple linear regression model was fitted with score differential as the response variable and offensive play balance as the predictor variable. The results show a statistically significant positive association between offensive play balance and score differential, suggesting that teams with a more balanced offense tend to have better score differentials, reflecting higher overall team strength and more wins. These results may help NFL teams optimize offensive playcalls and resource allocation for the draft and offseason priorities. Future work includes performing this analysis with multiple predictors such as defensive statistics, examining changes in offensive play balance over time, and exploring factors influencing playoff success."
format: pdf
...
```
@fig-offense-balance-qqplot shows the quantile-quantile plot. The errors seem to be normal, as the residuals lie close to the reference line shown in red.
```{r fig-offense-balance-time}
#| echo: false
#| warning: false
#| message: false
#| fig-cap: "Residuals plotted against year (time) for the offense play balance regression model."
#| fig-pos: "H"
plot_dat <- data.frame(
  resid = resid(lm_fit),
